...
#' @param qs quantiles of the null distribution to extract, generally 0.025 and 0.975
#'
...
#' @return raw_lower - a matrix containing null values extracted for the quantil of 0.025 without subtracting the mean and divided by standard deviation (see equation for calculating the standardize effect size on the function code)
#' @return raw_lower - a matrix containing null values extracted for the quantil of 0.975 without subtracting the mean and divided by standard deviation (see equation for calculating the standardize effect size on the function code)
#'
#'@example
#' #import data
