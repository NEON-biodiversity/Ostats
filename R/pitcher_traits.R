...
#'
#' These data represent trait information collected on carnivorous pitchers of the Northern Pitcher plant, *Sarracenia purpurea*, at 36 sites across the species native North American latitudinal range 30.197 $^\circ$N – 53.722 $^\circ$N (Freedman et al. 2021). Pitcher traits measured include orthogonal rosette diameters, pitcher length, pitcher width, keel width, mouth diameter, and lip thickness. See Ellison and Gotelli (2002) for a diagram illustrating traits measured.
#'
#' @references 
