...
To specify a circular analysis, the user sets data_type = "circular" when the data are circular and continuous, and data_type = "circular_discrete" if the data are collected every hour.
