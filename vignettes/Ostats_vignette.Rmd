...
Below is the input dataset. Each row represents an individual small mammal that was trapped and weighed, with information of its local of capture (siteID), species identity (taxonID), body mass in grams and the log value of the body mass in grams. 
