...
* `limits_x` a vector of length 2: it sets the limits (min and max values) of the x-axis. The default x-axis limits are: a minimum of 0.5 times the minimum observed trait measurement (with `NA`s removed) and a maximum of 1.5 times the maximum observed trait measurement. Or in other words: `c(0.5*min(trait,na.rm=TRUE), 1.5*max(trait,na.rm=TRUE))`.
