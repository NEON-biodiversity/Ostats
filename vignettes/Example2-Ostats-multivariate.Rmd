...
This vignette on multivariate trait overlap statistics is intended for users who are already familiar with the univariate O-statistics we introduce in the [first package vignette](Ostats-univariate.html).
