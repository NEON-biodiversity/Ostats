...
The argument `axis_buffer_factor` is set to expand the axes widely around the data points so that the estimated hypervolume contours do not get truncated.
